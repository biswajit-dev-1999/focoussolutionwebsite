        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_2fr] gap-16 mb-24 border-b border-white/10 pb-20">
          ...
          <div className="pr-0 md:pr-10">
            ...
            <div className="flex gap-4">
              ...
              <a href="mailto:hello@focussolutions.com" aria-label="Email" className="w-[46px] h-[46px] rounded-full border border-white/20 flex items-center justify-center text-white/70 transition-all duration-300 hover:bg-white hover:text-[#1A1A1A] hover:-translate-y-1 hover:border-white shadow-sm">
